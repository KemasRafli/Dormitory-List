...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dormitory').select2({
                width: '100%',
                placeholder: "Input Kamar...",
                ajax: {
                    url: '{{ url('dormitory/list') }}',
                    type: 'post',
                    dataType: 'json',
                    data: function (params) {
                        return {
            ...
            @if ($data->province)
                $.ajax({
                    ...
                    success:function(data) {
                        $('#province').append('<option value="'+ data.data.id +'">'+ data.data.name +'</option>')
                    }
                });
            @endif
            @if ($data->regency)
                $.ajax({
                    ...
                    type:'post',
                    dataType:'json',
                    data: { regency_id : '{{ $data->regency }}' },
                    success:function(data) {
                        $('#regency').append('<option value="'+ data.data.id +'">'+ data.data.name +'</option>')
                    }
                });
            @endif
            @if ($data->district)
                $.ajax({
                    ...
                    success:function(data) {
                        $('#district').append('<option value="'+ data.data.id +'">'+ data.data.name +'</option>')
                    }
                });
            @endif
            @if ($data->village)
                $.ajax({
                    ...
                    success:function(data) {
                        $('#village').append('<option value="'+ data.data.id +'">'+ data.data.name +'</option>')
                    }
                });
            @endif
        </script>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="student[recitation_group_id]"
                                                id="recitation_group" style="width:100%" disabled></select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="student_detail[nationality]">
                                                ...
                                                @endswitch
                                                @else
                                                <option value="chosee">(Pilih)</option>
                                                <option value="wni">Indonesia</option>
                                                <option value="wna">Asing</option>
                                                @endif
                                            </select>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                <div class="form-group" style="width:100%">
                                                    ...
                                                    <select id="province" class="form-control select2" name="student_detail[province]" style="width:100%"></select>
                                                </div>
                                                <div class="form-group" style="width:100%">
                                                    <label for="name">Kecamatan</label>
                                                    <select id="district" class="form-control select2" name="student_detail[district]" style="width:100%"></select>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                <div class="form-group" style="width:100%">
                                                    <label for="name">Kabupaten/Kota</label>
                                                    <select id="regency" class="form-control select2" name="student_detail[regency]" style="width:100%"></select>
                                                </div>
                                                <div class="form-group" style="width:100%">
                                                    <label for="name">Kelurahan</label>
                                                    <select id="village" class="form-control select2" name="student_detail[village]" style="width:100%"></select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" oninput="input_only_number(event)" class="form-control" name="student_detail[student_phone]"
